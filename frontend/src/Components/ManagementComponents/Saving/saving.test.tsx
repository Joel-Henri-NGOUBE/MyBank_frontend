...
describe("ManagementComponents tests", () => {
    it("Should have Saving as the active page", async () => {
        ...
        await userEvent.click(managementActions[2])

        expect(managementActionsDiv).not.toBeInTheDocument()
        
        // As the saving and management header are not in the document by default
